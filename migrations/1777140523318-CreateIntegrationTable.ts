...
export class CreateIntegrationTable1777140523318 implements MigrationInterface {
    name = 'CreateIntegrationTable1777140523318'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "integration" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "omBotToken" character varying, "slackTeamId" character varying, "slackBotToken" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "REL_e38baca49ddff880b963fcb5d0" UNIQUE ("userId"), CONSTRAINT "PK_f348d4694945d9dc4c7049a178a" PRIMARY KEY ("id"))`);
